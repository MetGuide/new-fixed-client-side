...
# END_OFFLINE_SHOPS_METGUIDE
	...
	def MakeHyperlinkTooltip(self, hyperlink):
		...
		if tokens and len(tokens):
			...
			elif app.METGUIDE_ENABLE_LINK_IN_CHAT and "web" == type and tokens[1].startswith("httpXxX") or "web" == type and tokens[1].startswith("httpsXxX"):
			...
			elif app.METGUIDE_ENABLE_LINK_IN_CHAT and "sysweb" == type:
	...
	def Close(self):
		...
		if uiQuest.QuestDialog.__dict__.has_key("QuestCurtain"):
			...
			del uiQuest.QuestDialog.QuestCurtain #@METGUIDEwork13 it's recreated only if it's deleted from scope
