...
def FReturnInfo(func,index):
	(vnum_reward,count_reward,item_reward_stackable,vnum_material_1,count_material_1,vnum_material_2,count_material_2,vnum_material_3,count_material_3,vnum_material_4,count_material_4,vnum_material_5,count_material_5,vnum_material_6,count_material_6,gold,gem,gem2,percent,category) = cube_renewal.GetDates(index)
	info = {
			...
			"vnum_material_6" : vnum_material_6,
			"count_material_6" : count_material_6,
			"gold" : gold,
			"gem" : gem,
			"gem2" : gem2,
			"percent" : percent,
...
class CubeRenewalWindows(ui.ScriptWindow):
	...
	def LoadWindow(self):
		...
		try:
			...
			# self.gem2_text = self.GetChild("gem2_text")
		...
		self.icons_items.SetSize((32*10),32*3)
		...
		for i in xrange(0,7):
			self.icons_items.AppendSlot(i+1,46*i+62-2,0,32,32*3)
